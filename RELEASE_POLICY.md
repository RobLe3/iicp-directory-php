...
- Git tag and `VERSION`: PHP implementation release (`v1.10.82`);
...
gh attestation verify iicp-directory-php-v1.10.82.tar.gz \
  --repo RobLe3/iicp-directory-php
```

## Compatibility

- PHP: 8.3.x is the supported runtime line for v1.10.82.
