...
final class NodeRegistrationPersistence
{
    ...
    private function applyReRegistrationUpdate(
        ...
        $node->update([
            ...
            'implementation_name' => $data['implementation_name'] ?? $node->implementation_name,
            'implementation_version' => $data['implementation_version'] ?? $node->implementation_version,
            'sdk_compatibility_version' => $data['sdk_compatibility_version'] ?? $node->sdk_compatibility_version,
    ...
    private function createFreshNode(
        ...
        return Node::create([
            ...
            'implementation_name' => $data['implementation_name'] ?? null,
            'implementation_version' => $data['implementation_version'] ?? null,
            'sdk_compatibility_version' => $data['sdk_compatibility_version'] ?? null,
